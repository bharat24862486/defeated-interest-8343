    ...
    <Box>{check ? <MobNav3 makeFalse={makeFalse} /> :
      <Box><Nav makeTrue={makeTrue} />
        ...
        <Footer />
          ...
          />
          <Homefetch
            url={`https://unusual-gold-button.cyclic.app/product?category=Vitamin`}
            title={"Buy 1 Get 1 Free"}
          />
          <HomeProductCard3 img1={b6} img2={b7} img3={b8} img4={b9} />
          <Homefetch
            url={`https://unusual-gold-button.cyclic.app/product?category=Fitness`}
            title={"Extra 5% Off + 5% HK Cash"}
          />
          <HomeProductCard4 />
          <HomeProductCard5 />
          <HomeProductCard6 />
