            ...
            {handle?"":<Flex justifyContent={"space-between"}>
                <Box w={["15%","15%","15%"]}>
                    <Flex justifyContent={"space-between"} alignItems={"center"} p={"0% 1%"}>
                        ...
                        <Text   fontWeight={"650"} bgColor={"#00B5B7"} color={"white"} fontSize={["1rem","1.2rem","1.3rem"]} onClick={()=>navigate("/")} cursor={"pointer"}>HC</Text>
                    </Flex>
                ...
                <Box w={["15%","15%","20%"]}>
                    <Flex justifyContent={"space-between"} alignItems={"center"}>
                        ...
                        <IconButton bgColor={"white"} onClick={()=>navigate("/cart")}><CiShoppingCart size={"55%"} /></IconButton>
                    </Flex>
